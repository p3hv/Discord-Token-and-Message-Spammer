...
The **Discord $pammer** is a tool designed to send multiple messages quickly and frequently ($pam) across Discord channels. It supports:  
...
---
### Notes
+ the more sessions+tokens the faster the $pam (multi hosts from different networks) same goes with webhook %pamming
